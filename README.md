...
```bash
npm install /absolute/path/to/node-red-contrib-unifi-ultimate
```
...
- UniFi Protect Getting Started: https://developer.ui.com/protect/v6.2.88/gettingstarted
- UniFi Protect Get Application Info: https://developer.ui.com/protect/v6.2.88/get-v1metainfo
- UniFi Protect Get Cameras: https://developer.ui.com/protect/v6.2.88/get-v1cameras
- UniFi Protect Get Camera Details: https://developer.ui.com/protect/v6.2.88/get-v1camerasid
- UniFi Protect Get Sensors: https://developer.ui.com/protect/v6.2.88/get-v1sensors
- UniFi Protect Get Lights: https://developer.ui.com/protect/v6.2.88/get-v1lights
- UniFi Protect Get Chimes: https://developer.ui.com/protect/v6.2.88/get-v1chimes
- UniFi Protect Get Viewers: https://developer.ui.com/protect/v6.2.88/get-v1viewers
- UniFi Protect Patch Viewer: https://developer.ui.com/protect/v6.2.88/patch-v1viewersid
- UniFi Protect Get Live Views: https://developer.ui.com/protect/v6.2.88/get-v1liveviews
- UniFi Protect Patch Live View: https://developer.ui.com/protect/v6.2.88/patch-v1liveviewsid
- UniFi Protect Get NVR Details: https://developer.ui.com/protect/v6.2.88/get-v1nvrs
- UniFi Protect Get Device Asset Files: https://developer.ui.com/protect/v6.2.88/get-v1filesfiletype
- UniFi Protect Upload Device Asset File: https://developer.ui.com/protect/v6.2.88/post-v1filesfiletype
- UniFi Protect Patch Sensor: https://developer.ui.com/protect/v6.2.88/patch-v1sensorsid
- UniFi Protect Patch Light: https://developer.ui.com/protect/v6.2.88/patch-v1lightsid
- UniFi Protect Patch Chime: https://developer.ui.com/protect/v6.2.88/patch-v1chimesid
- UniFi Protect Patch Camera: https://developer.ui.com/protect/v6.2.88/patch-v1camerasid
- UniFi Protect WebSocket Device Updates: https://developer.ui.com/protect/v6.2.88/get-v1subscribedevices
- UniFi Protect WebSocket Events: https://developer.ui.com/protect/v6.2.88/get-v1subscribeevents
